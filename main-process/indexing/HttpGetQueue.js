...
var HttpGetQueue = /** @class */ (function () {
    function HttpGetQueue(client) {
        this.queue$ = new rxjs_1.Subject();
        this.results = this.queue$.pipe(operators_1.concatMap(function (dataset) { return sendRequest(client, dataset); }));
    }
    HttpGetQueue.prototype.addToQueue = function (data) {
